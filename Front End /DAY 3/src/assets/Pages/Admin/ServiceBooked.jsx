...
const ServiceBooked = () => {
  const [users, setUsers] = useState([
    { id: 1, name: 'Siva', position: 'Health-Care', company: '26-01-2024', selected: true },
    { id: 2, name: 'Jane Smith', position: 'Food-Care', company: '27-01-2024', selected: true },
          ...
          <TableBody>
            {users.map((user) => (
              <TableRow key={user.id}>
                ...
                <TableCell>{user.selected ? 'Booked' : 'Not Booked'}</TableCell>
                <TableCell>
